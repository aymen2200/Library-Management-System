...
const {register, login, getAllUsers, getMe,userHistory, deleteUser,changePassword, changeName, getUserFines, updatePfp}= require('../Controllers/userCtrls');
...
router.put('/pfp', authenticate, updatePfp);

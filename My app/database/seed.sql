...
-- BORROWINGRECORDS
-- ------------------------------------------------------------
INSERT INTO BorrowingRecords (BorrowingRecordID, UserID, CopyID, BorrowingDate, DueDate, ActualReturnDate, Status) VALUES
  (1,  2,  2,  '2025-04-01', '2025-04-15', '2025-04-13', 'returned'),
  (2,  3,  5,  '2025-04-05', '2025-04-19', NULL,          'borrowed'),
  (3,  4,  8,  '2025-04-10', '2025-04-24', NULL,          'borrowed'),
  (4,  5,  11, '2025-03-20', '2025-04-03', '2025-04-10', 'returned'),
  (5,  6,  15, '2025-04-12', '2025-04-26', NULL,          'borrowed'),
  (6,  7,  19, '2025-03-15', '2025-03-29', '2025-04-05', 'returned'),
  (7,  8,  22, '2025-04-08', '2025-04-22', NULL,          'borrowed'),
  (8,  9,  26, '2025-04-14', '2025-04-28', NULL,          'borrowed'),
  (9,  10, 2,  '2025-03-01', '2025-03-15', '2025-03-14', 'returned'),
  (10, 11, 5,  '2025-03-10', '2025-03-24', '2025-04-01', 'returned');
